...
/**
 * <h1>This Message class contains the Ping-Signal for indicating the connection
 * state.</h1>
 * 
 * 
...
public class MessPing extends Message implements Serializable {
	 ...
	 * @author Taner Bulut, 5298261
	 * @param type
	 *            the maintype (=100) of the message
	 * @param subType
	 *            the subtype (=0) of the message
	 */
	public MessPing(int type, int subType) {
		// Sets the maintype and the subtype of the Message
		super(type, subType);
	}
